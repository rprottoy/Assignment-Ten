    ...
    <div className="w-full ">
      ...
      <div>
        ...
        >
          <img
            ...
            alt=""
          />
          <div className="absolute  inset-0 text-center mt-15 brightness-120">
      ...
      <div className="md:max-w-11/12 lg:max-w-11/12 max-w-11/12 mx-auto  mb-15">
        ...
        <div className="md:grid md:grid-cols-4 lg:grid-col-4 ">
          {browseCars.map((car) => (
            <div className="overflow-hidden hover:-translate-y-1  transition-all duration-500 cursor-pointer md:w-[320px] w-full h-fit mb-10">
              {/* image div */}
              <div>
                <img
